...
export default function ModifyV1() {
    ...
    const modify = async () => {
        ...
        try {
            console.log(versionSelect)
            const tx = await contract.setLicenseForBASTARD(versionSelect,bastardID,text)
            setReadLicense(tx)
        ...
        <div className="bg-red-500 flex flex-col justify-center p-5 charriot min-h-screen">
            <div className="bg-red-500 flex flex-col  p-5 text-3xl">
                ...
                <div className="flex  items-center justify-around">
                    ...
                    <p>SELECT STORAGE:</p>
                    <select className={"p-5 "} placeholder={"PROVIDER"} onChange={e => setStorage(e.target.value)}>
                    ...
                    <button className={"mt-5 bg-blau p-5"} onClick={modify}>
                        MODIFY V{versionSelect} - {bastardID}
                    </button>
